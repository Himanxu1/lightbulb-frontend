...
const FeatureIdeaCard = (props) => {
  return (
    <div className="shadow-md border shadow-gray-300 hover:shadow-2xl rounded-md w-[280px]  h-[380px]">
    <img
      src={props.imageUrl}
      className="w-12 h-12 mt-8 ml-6"
    />
    <p className="font-medium px-6 mt-4 text-[18px]">
     {props.title}
    </p>
    <p className="text-[15px] px-6 mt-4">
     {props.description}
    </p>
