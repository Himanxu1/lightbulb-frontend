        ...
        <div className="rounded-lg shadow-md flex flex-col w-full bg-white">
          <div className=" h-fit max-h-96 overflow-y-auto">
            <div className="sticky top-0 bg-white pt-4 px-4">
              <h2 className="myFont sm:text-[20px] text-[18px] font-medium mb-2">
                Voucher Details
              </h2>
              <hr className="mb-2" />
            </div>
            ...
            {isLoading ? (
              <p className="myFont text-gray-500 font-normal m-5">Loading...</p>
            ) : vouchersData.length === 0 ? (
              <p className="myFont text-gray-500 font-normal m-5">
              ...
              vouchersData.map((voucher, ind) => (
                ...
                >
                  ...
                  <div className="sm:flex w-full sm:ml-0 ml-5">
                    <p className="myFont w-[160px] sm:ml-5 truncate">
                      {voucher[0]?.name ? voucher[0]?.name : "user name"}
                    </p>
                    <p className="myFont w-3/5 truncate">
